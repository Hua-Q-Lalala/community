...
public class ShareController implements CommunityConstant {
    ...
    public String share(String htmlUrl){
        ...
        //map.put("shareUrl", domain + contextPath + "/share/image/" + fileName);     //上传到本地
        map.put("shareUrl", shareBucketUrl + "/" + fileName);     //上传到七牛云

        return CommunityUtil.getJsonString(0, null, map);
    }

    /**
     * 2022-5-22 废弃，从本地获取分享图片改为从七牛云上获取分享图片
     *
     * 获取长图
     * @param fileName  图片名称
     * @param response
