...
public class UserController implements CommunityConstant{
    ...
    /**
     * 2022-5-22 废弃，由读取本地图片改为读取七牛云服务器上的图片
     *
    ...
    public String getMyPost(@PathVariable("userId") int userId, Model model, Page page){
        ...
        //user发布过的所有帖子, 按置顶到最热再到创建时间排序
        List<DiscussPost> list = discussPostService.findDiscussPosts(user.getId(), page.getOffset(), page.getLimit(), 1);
